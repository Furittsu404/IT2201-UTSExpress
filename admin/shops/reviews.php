                            ...
                            <div class="product-row gap-3 justify-content-center align-content-center">
                                ...
                                <?php if (count($result3) > 0): ?>
                                    <?php for ($j = 0; $j < count($result3); $j++): ?>
                                        <div class="product py-3 overflow-hidden">
                                            <div class="product-image">
                                                <img src="../../img/<?= $result3[$i][4] ?>/products/<?= $result3[$j][0] ?>.png">
                                            </div>
                                            <h1><?= $result3[$j][1] ?></h1>
                                            <button class='edit w-40 btn btn-success' onclick='window.location.href="editProducts.php?shop_ID=<?=$result3[$j][0]?>"'><span class="action-word">Edit</span><i class='bi bi-pencil action-btn'></i></button> <button class='delete w-40 btn btn-outline-danger' onclick='window.location.href="deleteProducts.php?shop_ID=<?= $result3[$j][0] ?>"'><span class='action-word'>Delete</span><i class='bi bi-trash action-btn'></i></button>
                                        </div>
                                    <?php endfor; ?>
                                <?php endif; ?>
                            </div>
