...
if (isset($_POST['delete'])) {
    $action = $database->deleteRecord('driverlogin', ['driver_ID' => $driver_id]);
    $action2 = $database->deleteRecord('driverdata', ['driver_ID' => $driver_id]);
    echo "<script>alert('Deleted Driver data successfully.'); window.location.href='profiles.php?page=' + " . $_SESSION['page'] . "</script>";
    exit();
}
?>
    ...
    <div class="wrapper">
        ...
        <div class="main p-3 d-flex flex-column align-content-center">
            ...
            <form class="container" method="post">
                <h1 class="display-5 ">Delete Driver?</h1> <br>
                <div class="form-group row">
                    <label for="driver_Name" class="col-sm-2 col-form-label fw-bold">Name</label>
                    <div class="col-sm-10">
                ...
                <br>
                <div class="form-group row">
                    <label for="driver_Nickname" class="col-sm-2 col-form-label fw-bold">Nickname</label>
                    <div class="col-sm-10">
                ...
                <br>
                <div class="form-group row">
                    <label for="driver_Email" class="col-sm-2 col-form-label fw-bold">Email</label>
                    <div class="col-sm-10">
                ...
                <br>
                <div class="form-group row">
                    <label for="driver_Phone" class="col-sm-2 col-form-label fw-bold">Phone</label>
                    <div class="col-sm-10">
                ...
                <br>
                <div class="form-group row">
                    <label for="driver_Location" class="col-sm-2 col-form-label fw-bold">Location</label>
                    <div class="col-sm-10">
